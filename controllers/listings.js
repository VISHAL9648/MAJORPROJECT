...
const geocondingClient = mbxGeocoding({accessToken: mapToken });
...
module.exports.createListing =async (req, res, next)=>{
  ...
  if (!req.body.listing || !req.body.listing.country) {
    return res.status(400).json({ error: "listing.country is required" });
}
